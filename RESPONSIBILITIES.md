...
It is important that commit messages are helpful in understanding the reasons for a given code commit and maintain good code commit hygiene by keeping only the relevant information. 
